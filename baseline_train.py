...
def main():
    ...
    plot_pred_true_distributions_with_ci(
            ...
            plot_type="hist",                # or "hist"
            bins=100,                  # histogram bins
            save_path=f"figs/pred_vs_true_gbm_{args.author_drop_mode}_hist.png",
            show=False)
    ...
    plot_yearly_aggregates(
            ...
            show_iqr=True,
            save_path=f"./figs/yearly_median_iqr_{args.author_drop_mode}_kde.png",
